    ...
    <div class="flex gap-6">
          ...
          <table class="min-w-full bg-white shadow rounded-lg overflow-hidden">
            ...
            <tbody class="text-sm text-gray-700 divide-y divide-gray-200">
              ...
              >
                ...
                <td class="px-4 py-2">{{ consent.expirationDateTime || '—' }}</td>
      ...
      >
        <div>
          ...
          <div class="font-mono text-sm text-gray-800">{{ selectedConsent?.consentId }}</div>
        </div>
        ...
        <div>
          ...
          <div class="text-gray-800">{{ selectedConsent?.creationDateTime }}</div>
        </div>

        <div>
          <div class="text-gray-500 text-xs uppercase">Status Update At</div>
          <div class="text-gray-800">{{ selectedConsent?.statusUpdateDateTime }}</div>
        </div>

        <div>
          <div class="text-gray-500 text-xs uppercase">Expires At</div>
          <div class="text-gray-800">{{ selectedConsent?.expirationDateTime || '—' }}</div>
        </div>
...
const sidebarLinks = [{ label: 'Consents', path: `/orgs/${orgId}/users/${userId}/consents` }]
